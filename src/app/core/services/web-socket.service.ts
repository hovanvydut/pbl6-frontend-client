...
export class WebSocketService {
  public data: any[];
  private notificationEmitter = new EventEmitter<NotificationModel>(null);
  ...
  public connect() {
    if (
      !this.baseService.currentUser ||
      !this.baseService.currentUser.id ||
  ...
  subscribeNotification(): EventEmitter<NotificationModel> {
