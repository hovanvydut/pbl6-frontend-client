...
import { StatisticDetailParamsModel, StatisticParamsModel } from '../models/statistic.model';
...
export class StatisticService {
  ...
  getTotalStatistic(params: StatisticParamsModel): Observable<any> {
    ...
    Object.keys(params)
      ...
      .join('&');
    return this.baseService.get(`post-statistic/total-value${queryString}`);
  }
  ...
  getStatisticDetail(params: StatisticDetailParamsModel): Observable<any> {
    ...
    Object.keys(params)
      ...
      .join('&');
    return this.baseService.get(`post-statistic/detail${queryString}`);
  }
  ...
  getStatisticTop(params: StatisticDetailParamsModel): Observable<any> {
    ...
    Object.keys(params)
      ...
      .join('&');
    return this.baseService.get(`post-statistic/top${queryString}`);
  }
}
